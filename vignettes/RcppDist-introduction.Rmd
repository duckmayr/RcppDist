...
- Add Rcpp and RcppDist to the LinkingTo field of your DESCRIPTION file.
- Add Rcpp to the Imports field of your DESCRIPTION file.
...
- Add Rcpp, RcppArmadillo, and RcppDist to the LinkingTo field of your DESCRIPTION file.
- Add Rcpp to the Imports field of your DESCRIPTION file.
- Remember to add the appropriate `PKG_LIBS` flags to `src/Makevars` and `sr/Makevars.win` (see the RcppArmadillo manual for more details).
